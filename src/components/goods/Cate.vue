...
<script>
import { cateListData, ParentCateListData, addCateData } from "../../network/home";
...
export default {
  ...
  methods: {
    // 获取商品分类数据
    getCateList() {
      cateListData(this.querInfo).then((res) => {
    ...
    addCate() {
      this.$refs.addCateFormRef.validate(valid => {
        if (!valid) return;
        addCateData(this.addCateForm).then(res => {
